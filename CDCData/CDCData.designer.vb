...
Partial Public Class CDCDataDataContext
  ...
  #End Region
	...
	Public Sub New()
		MyBase.New(Global.CDCData.My.MySettings.Default.HPB_LogisticsConnectionString, mappingSource)
		OnCreated
	End Sub
	...
	<FunctionAttribute(Name:="dbo.DS_ProdMstUpdateStatus")>  _
	Public Function DS_ProdMstUpdateStatus(<Parameter(Name:="ItemCode", DbType:="VarChar(20)")> ByVal itemCode As String, <Parameter(Name:="Status", DbType:="Int")> ByVal status As System.Nullable(Of Integer)) As Integer
		Dim result As IExecuteResult = Me.ExecuteMethodCall(Me, CType(MethodInfo.GetCurrentMethod,MethodInfo), itemCode, status)
		Return CType(result.ReturnValue,Integer)
	End Function
	
	<FunctionAttribute(Name:="dbo.DS_OrderHdrUpdateStatus")>  _
	Public Function DS_OrderHdrUpdateStatus(<Parameter(Name:="PONumber", DbType:="VarChar(20)")> ByVal pONumber As String, <Parameter(Name:="Status", DbType:="Int")> ByVal status As System.Nullable(Of Integer)) As Integer
		Dim result As IExecuteResult = Me.ExecuteMethodCall(Me, CType(MethodInfo.GetCurrentMethod,MethodInfo), pONumber, status)
		Return CType(result.ReturnValue,Integer)
	End Function
	
	<FunctionAttribute(Name:="dbo.WMS_CDC_DropShipments")>  _
	Public Function WMS_CDC_DropShipments(<Parameter(DbType:="NText")> ByVal xml As String, <Parameter(Name:="File", DbType:="VarChar(50)")> ByVal file As String) As Integer
		Dim result As IExecuteResult = Me.ExecuteMethodCall(Me, CType(MethodInfo.GetCurrentMethod,MethodInfo), xml, file)
		Return CType(result.ReturnValue,Integer)
	End Function
	
	<FunctionAttribute(Name:="dbo.WMS_ILS_ShipmentRecords")>  _
	Public Function WMS_ILS_ShipmentRecords(<Parameter(DbType:="NText")> ByVal xml As String, <Parameter(Name:="File", DbType:="VarChar(50)")> ByVal file As String) As Integer
		Dim result As IExecuteResult = Me.ExecuteMethodCall(Me, CType(MethodInfo.GetCurrentMethod,MethodInfo), xml, file)
		Return CType(result.ReturnValue,Integer)
	End Function
	
	<FunctionAttribute(Name:="dbo.WMS_ILS_UpdShipRecs")>  _
	Public Function WMS_ILS_UpdShipRecs(<Parameter(DbType:="DateTime")> ByVal procDate As System.Nullable(Of Date)) As Integer
...
Partial Public Class POHeader
	...
	<Column(Storage:="_PONumber", DbType:="Char(6) NOT NULL", CanBeNull:=false, IsPrimaryKey:=true)>  _
	...
	<Column(Storage:="_LocationNo", DbType:="Char(5)")>  _
	...
	<Column(Storage:="_POType", DbType:="VarChar(1)")>  _
	...
	<Column(Storage:="_BuyerID", DbType:="VarChar(10)")>  _
	...
	<Column(Storage:="_VendorID", DbType:="VarChar(10)")>  _
	...
	<Column(Storage:="_TermsCode", DbType:="VarChar(10)")>  _
	...
	<Column(Storage:="_PODate", DbType:="SmallDateTime")>  _
	...
	<Column(Storage:="_CancelDate", DbType:="SmallDateTime")>  _
	...
	<Column(Storage:="_DueDate", DbType:="SmallDateTime")>  _
	...
	<Column(Storage:="_OrderAmount", DbType:="Money")>  _
	...
	<Column(Storage:="_Printed", DbType:="Bit NOT NULL")>  _
	...
	<Column(Storage:="_SendPO", DbType:="Bit NOT NULL")>  _
	...
	<Column(Storage:="_SpecInstructions", DbType:="VarChar(255)")>  _
	...
	<Column(Storage:="_Complete", DbType:="Bit NOT NULL")>  _
	...
	<Column(Storage:="_DateComplete", DbType:="SmallDateTime")>  _
	...
	<Column(Storage:="_SkeletonCreatedFrom", DbType:="VarChar(6)")>  _
	...
	<Column(Storage:="_CreatedFromRequisition", DbType:="Bit")>  _
	...
	<Column(Storage:="_ShipToName", DbType:="VarChar(30)")>  _
	...
	<Column(Storage:="_ShipToAddress1", DbType:="VarChar(30)")>  _
	...
	<Column(Storage:="_ShipToAddress2", DbType:="VarChar(30)")>  _
	...
	<Column(Storage:="_ShipToAddress3", DbType:="VarChar(30)")>  _
	...
	<Association(Name:="POHeader_PODetail", Storage:="_PODetails", ThisKey:="PONumber", OtherKey:="PONumber")>  _
...
Partial Public Class PODetail
	...
	<Column(Storage:="_POLine", DbType:="Char(5) NOT NULL", CanBeNull:=false, IsPrimaryKey:=true)>  _
	...
	<Column(Storage:="_ItemCode", DbType:="VarChar(20)")>  _
	...
	<Column(Storage:="_ISBN", DbType:="VarChar(13)")>  _
	...
	<Column(Storage:="_DistributionType", DbType:="Char(1)")>  _
	...
	<Column(Storage:="_OrderQty", DbType:="Int")>  _
	...
	<Column(Storage:="_UnitType", DbType:="VarChar(3)")>  _
	...
	<Column(Storage:="_UnitCost", DbType:="Money")>  _
	...
	<Column(Storage:="_ExtendedLineCost", DbType:="Money")>  _
	...
	<Column(Storage:="_SchemeID", DbType:="Char(20)")>  _
	...
	<Column(Storage:="_FileClaimAdjustment", DbType:="Bit NOT NULL")>  _
	...
	<Column(Storage:="_VoucherNo", DbType:="VarChar(10)")>  _
	...
	<Column(Storage:="_SpecialInstructions", DbType:="VarChar(50)")>  _
	...
	<Column(Storage:="_Discount", DbType:="Float")>  _
	...
	<Column(Storage:="_RemovedFromReceiver", DbType:="Bit")>  _
	...
	<Column(Storage:="_QtyCounted", DbType:="Int")>  _
	...
	<Column(Storage:="_QtyPer", DbType:="Int")>  _
	...
	<Column(Storage:="_ExtendedQty", DbType:="Int")>  _
	...
	<Column(Storage:="_RowAddedFrom", DbType:="VarChar(20)")>  _
	...
	<Column(Storage:="_RowAddedByUser", DbType:="Char(10)")>  _
	...
	<Column(Storage:="_RowAddedDate", DbType:="DateTime")>  _
	...
	<Association(Name:="POHeader_PODetail", Storage:="_POHeader", ThisKey:="PONumber", OtherKey:="PONumber", IsForeignKey:=true)>  _
...
<Table(Name:="dbo.RequisitionDetail")>  _
Partial Public Class RequisitionDetail
	...
	<Column(Storage:="_RequisitionNo", DbType:="Char(6) NOT NULL", CanBeNull:=false, IsPrimaryKey:=true)>  _
	...
	<Column(Storage:="_ItemCode", DbType:="Char(20) NOT NULL", CanBeNull:=false, IsPrimaryKey:=true)>  _
	Public Property ItemCode() As String
		Get
			Return Me._ItemCode
		End Get
	...
	<Column(Storage:="_ItemRequestDate", DbType:="DateTime NOT NULL")>  _
	...
	<Column(Storage:="_RequestedQtyToOrder", DbType:="Int")>  _
	...
	<Column(Storage:="_UnitType", DbType:="Char(10)")>  _
	Public Property UnitType() As String
		Get
			Return Me._UnitType
		End Get
	...
	<Column(Storage:="_Approved", DbType:="Bit")>  _
	...
	<Column(Storage:="_ApprovedBy", DbType:="VarChar(20)")>  _
	...
	<Column(Storage:="_ApprovedQtyToOrder", DbType:="Int")>  _
	...
	<Column(Storage:="_DateApprovedDisapproved", DbType:="SmallDateTime")>  _
...
<Table(Name:="dbo.RequisitionHeader")>  _
Partial Public Class RequisitionHeader
	...
	<Column(Storage:="_RequestBy", DbType:="VarChar(20)")>  _
	...
	<Column(Storage:="_RequisitionDate", DbType:="DateTime")>  _
	...
	<Column(Storage:="_LastDateVoided", DbType:="DateTime")>  _
	...
	<Column(Storage:="_LastDateVoidedBy", DbType:="VarChar(20)")>  _
	...
	<Column(Storage:="_Comments", DbType:="VarChar(50)")>  _
...
<Table(Name:="dbo.ProductMaster")>  _
Partial Public Class ProductMaster
	...
	<Column(Storage:="_ItemAlias", DbType:="VarChar(18)")>  _
	...
	<Column(Storage:="_Description", DbType:="VarChar(70) NOT NULL", CanBeNull:=false)>  _
	...
	<Column(Storage:="_ProductType", DbType:="VarChar(4) NOT NULL", CanBeNull:=false)>  _
	...
	<Column(Storage:="_ValidCost", DbType:="Char(1) NOT NULL")>  _
	...
	<Column(Storage:="_Cost", DbType:="Money NOT NULL")>  _
	...
	<Column(Storage:="_CostBasis", DbType:="VarChar(2) NOT NULL", CanBeNull:=false)>  _
	...
	<Column(Storage:="_PriceMethod", DbType:="VarChar(2) NOT NULL", CanBeNull:=false)>  _
	...
	<Column(Storage:="_AllowRegisterPricing", DbType:="Char(1) NOT NULL")>  _
	...
	<Column(Storage:="_AltPrice", DbType:="Money NOT NULL")>  _
	...
	<Column(Storage:="_SectionCode", DbType:="Char(10) NOT NULL", CanBeNull:=false)>  _
	...
	<Column(Storage:="_DistributionCategory", DbType:="VarChar(10) NOT NULL", CanBeNull:=false)>  _
	...
	<Column(Storage:="_SchemeID", DbType:="VarChar(20)")>  _
	Public Property SchemeID() As String
		Get
			Return Me._SchemeID
		End Get
	...
	<Column(Storage:="_Title", DbType:="VarChar(70) NOT NULL", CanBeNull:=false)>  _
	...
	<Column(Storage:="_ISBN", DbType:="VarChar(13) NOT NULL", CanBeNull:=false)>  _
	Public Property ISBN() As String
		Get
			Return Me._ISBN
		End Get
	...
	<Column(Storage:="_PurchaseFromVendorID", DbType:="VarChar(10) NOT NULL", CanBeNull:=false)>  _
	...
	<Column(Storage:="_LastPurchaseOrder", DbType:="VarChar(6) NOT NULL", CanBeNull:=false)>  _
	...
	<Column(Storage:="_Note", DbType:="VarChar(30) NOT NULL", CanBeNull:=false)>  _
	...
	<Column(Storage:="_LastVoucherNumber", DbType:="VarChar(10) NOT NULL", CanBeNull:=false)>  _
	...
	<Column(Storage:="_LastInvoiceNo", DbType:="VarChar(10) NOT NULL", CanBeNull:=false)>  _
	...
	<Column(Storage:="_CreateDate", DbType:="SmallDateTime")>  _
	...
	<Column(Storage:="_ReclassFromItemCode", DbType:="VarChar(20) NOT NULL", CanBeNull:=false)>  _
	...
	<Column(Storage:="_Reorderable", DbType:="Char(1) NOT NULL")>  _
	...
	<Column(Storage:="_InternetItem", DbType:="Char(1) NOT NULL")>  _
	...
	<Column(Storage:="_InternetMinQty", DbType:="Int NOT NULL")>  _
	...
	<Column(Storage:="_InternetMaxQty", DbType:="Int NOT NULL")>  _
	...
	<Column(Storage:="_MfgSuggestedPrice", DbType:="Money")>  _
	...
	<Column(Storage:="_UpdateQOH", DbType:="Char(1) NOT NULL")>  _
	...
	<Column(Storage:="_AllowRegisterTitle", DbType:="Char(1) NOT NULL")>  _
	...
	<Column(Storage:="_KeyWords", DbType:="VarChar(50)")>  _
	...
	<Column(Storage:="_UserChar15", DbType:="VarChar(15) NOT NULL", CanBeNull:=false)>  _
	...
	<Column(Storage:="_UserChar30", DbType:="VarChar(30) NOT NULL", CanBeNull:=false)>  _
	...
	<Column(Storage:="_UserDate1", DbType:="DateTime")>  _
	...
	<Column(Storage:="_UserDate2", DbType:="DateTime")>  _
	...
	<Column(Storage:="_UserInt1", DbType:="Int NOT NULL")>  _
	...
	<Column(Storage:="_UserInt2", DbType:="Int NOT NULL")>  _
	...
	<Column(Storage:="_UserNum1", DbType:="Decimal(12,0) NOT NULL")>  _
	...
	<Column(Storage:="_UserNum2", DbType:="Decimal(12,0) NOT NULL")>  _
...
<Table(Name:="dbo.OrderHeaderDist")>  _
Partial Public Class PODist
	...
	<Column(Storage:="_WMSType", DbType:="VarChar(20)")>  _
...
<Table(Name:="dbo.ProductMasterDist")>  _
Partial Public Class ProductMasterDist
	...
	<Column(Storage:="_ItemCode", DbType:="VarChar(20) NOT NULL", CanBeNull:=false, IsPrimaryKey:=true)>  _
	Public Property ItemCode() As String
		Get
			Return Me._ItemCode
		End Get
	...
	<Column(Storage:="_VendorItemNo", DbType:="VarChar(14)")>  _
	...
	<Column(Storage:="_ASIN", DbType:="VarChar(10)")>  _
	...
	<Column(Storage:="_SchemeID", DbType:="VarChar(20) NOT NULL", CanBeNull:=false)>  _
	Public Property SchemeID() As String
		Get
			Return Me._SchemeID
		End Get
	...
	<Column(Storage:="_CreatedBy", DbType:="Char(10)")>  _
	...
	<Column(Storage:="_LastChangeBy", DbType:="Char(10)")>  _
	...
	<Column(Storage:="_LastChangeDate", DbType:="SmallDateTime")>  _
	...
	<Column(Storage:="_CalcCost", DbType:="Money NOT NULL")>  _
	...
	<Column(Storage:="_CalcDate", DbType:="DateTime")>  _
	...
	<Column(Storage:="_CalcOveride", DbType:="Char(1) NOT NULL")>  _
	...
	<Column(Storage:="_CalcDesc", DbType:="VarChar(50)")>  _
	...
	<Column(Storage:="_ReorderableItem", DbType:="Char(1) NOT NULL")>  _
	...
	<Column(Storage:="_RetailText", DbType:="VarChar(15)")>  _
	...
	<Column(Storage:="_UPC", DbType:="VarChar(20) NOT NULL", CanBeNull:=false)>  _
	...
	<Column(Storage:="_UnitsPerCase", DbType:="Int NOT NULL")>  _
	...
	<Column(Storage:="_TTBProdType", DbType:="VarChar(5) NOT NULL", CanBeNull:=false)>  _
...
<Table(Name:="dbo.vwStoreOrds2Export")>  _
Partial Public Class vwStoreOrds2Export
	...
	<Column(Storage:="_PONumber", DbType:="Char(6) NOT NULL", CanBeNull:=false)>  _
	Public Property PONumber() As String
		Get
			Return Me._PONumber
		End Get
	...
	<Column(Storage:="_RequisitionNo", DbType:="Char(6) NOT NULL", CanBeNull:=false)>  _
	Public Property RequisitionNo() As String
		Get
			Return Me._RequisitionNo
		End Get
	...
	<Column(Storage:="_OrderType", DbType:="VarChar(30)")>  _
	...
	<Column(Storage:="_StoreID", DbType:="VarChar(3)")>  _
	...
	<Column(Storage:="_Name", DbType:="VarChar(30) NOT NULL", CanBeNull:=false)>  _
	...
	<Column(Storage:="_GPCustomer", DbType:="VarChar(6)")>  _
	...
	<Column(Storage:="_SiteID", DbType:="VarChar(3)")>  _
	...
	<Column(Storage:="_MailToAddress1", DbType:="VarChar(30) NOT NULL", CanBeNull:=false)>  _
	...
	<Column(Storage:="_MailToAddress2", DbType:="VarChar(30) NOT NULL", CanBeNull:=false)>  _
	...
	<Column(Storage:="_MailToCity", DbType:="VarChar(30)")>  _
	...
	<Column(Storage:="_MailToState", DbType:="Char(4) NOT NULL", CanBeNull:=false)>  _
	...
	<Column(Storage:="_MailToZip", DbType:="VarChar(5)")>  _
...
<Table(Name:="dbo.vwStoreOrdDtls2Export")>  _
Partial Public Class vwStoreOrdDtls2Export
	...
	<Column(Storage:="_ItemCode", DbType:="Char(20) NOT NULL", CanBeNull:=false)>  _
	Public Property ItemCode() As String
		Get
			Return Me._ItemCode
		End Get
	...
	<Column(Storage:="_Company", DbType:="VarChar(15) NOT NULL", CanBeNull:=false)>  _
	...
	<Column(Storage:="_Markdown", DbType:="VarChar(30) NOT NULL", CanBeNull:=false)>  _
	...
	<Column(Storage:="_GPItemCode", DbType:="VarChar(8)")>  _
	...
	<Column(Storage:="_LineID", DbType:="Int")>  _
...
<Table(Name:="dbo.vwStorePOs2Export")>  _
Partial Public Class vwStorePOs2Export
	...
	<Column(Storage:="_Abbreviation", DbType:="VarChar(8) NOT NULL", CanBeNull:=false)>  _
	...
	<Column(Storage:="_MailToName", DbType:="VarChar(30) NOT NULL", CanBeNull:=false)>  _
	...
	<Column(Storage:="_MailToAddress3", DbType:="VarChar(30) NOT NULL", CanBeNull:=false)>  _
	...
	<Column(Storage:="_MailToCountry", DbType:="VarChar(20) NOT NULL", CanBeNull:=false)>  _
	...
	<Column(Storage:="_CountryCode", DbType:="Char(10) NOT NULL", CanBeNull:=false)>  _
	...
	<Column(Storage:="_StateCode", DbType:="Char(4) NOT NULL", CanBeNull:=false)>  _
	...
	<Column(Storage:="_VenName", DbType:="VarChar(30)")>  _
	...
	<Column(Storage:="_VenAdd1", DbType:="VarChar(30)")>  _
	...
	<Column(Storage:="_VenAdd2", DbType:="VarChar(30) NOT NULL", CanBeNull:=false)>  _
	...
	<Column(Storage:="_VenCity", DbType:="VarChar(25)")>  _
	...
	<Column(Storage:="_VenState", DbType:="VarChar(2)")>  _
	...
	<Column(Storage:="_VenZip", DbType:="VarChar(10)")>  _
	...
	<Column(Storage:="_VenTermsCode", DbType:="VarChar(10)")>  _
	...
	<Column(Storage:="_TermsDays", DbType:="Int NOT NULL")>  _
...
Partial Public Class vwPO2Export
	...
	<Column(Storage:="_WMSType", DbType:="VarChar(20) NOT NULL", CanBeNull:=false)>  _
	Public Property WMSType() As String
		Get
			Return Me._WMSType
		End Get
	...
	<Column(Storage:="_VenState", DbType:="VarChar(2) NOT NULL", CanBeNull:=false)>  _
	Public Property VenState() As String
		Get
			Return Me._VenState
		End Get
	...
	<Column(Storage:="_VenZip", DbType:="VarChar(10) NOT NULL", CanBeNull:=false)>  _
	Public Property VenZip() As String
		Get
			Return Me._VenZip
		End Get
	...
	<Column(Storage:="_VenTerms", DbType:="VarChar(15) NOT NULL", CanBeNull:=false)>  _
	...
	<Column(Storage:="_OrderType", DbType:="VarChar(30) NOT NULL", CanBeNull:=false)>  _
	Public Property OrderType() As String
		Get
			Return Me._OrderType
		End Get
...
<Table(Name:="dbo.vwPODtl2Export")>  _
Partial Public Class vwPODtl2Export
	...
	<Column(Storage:="_POLine", DbType:="Char(5) NOT NULL", CanBeNull:=false)>  _
	Public Property POLine() As String
		Get
			Return Me._POLine
		End Get
	...
	<Column(Storage:="_UOM", DbType:="VarChar(4) NOT NULL", CanBeNull:=false)>  _
...
Partial Public Class vwNewItem
	...
	<Column(Storage:="_ItemCode", DbType:="VarChar(8)")>  _
	Public Property ItemCode() As String
		Get
			Return Me._ItemCode
		End Get
	...
	<Column(Storage:="_Cost", DbType:="Decimal(8,2)")>  _
	...
	<Column(Storage:="_Price", DbType:="Decimal(8,2)")>  _
	...
	<Column(Storage:="_Section", DbType:="Char(10) NOT NULL", CanBeNull:=false)>  _
	...
	<Column(Storage:="_DistCat", DbType:="VarChar(10) NOT NULL", CanBeNull:=false)>  _
	...
	<Column(Storage:="_MSRP", DbType:="Decimal(8,2)")>  _
	...
	<Column(Storage:="_UnitsPer", DbType:="Int NOT NULL")>  _
	...
	<Column(Storage:="_HPBProdType", DbType:="VarChar(4) NOT NULL", CanBeNull:=false)>  _
	...
	<Column(Storage:="_WhsleText", DbType:="VarChar(15)")>  _
	...
	<Column(Storage:="_MarkDownPrcLv", DbType:="VarChar(1) NOT NULL", CanBeNull:=false)>  _
